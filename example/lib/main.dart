...
import 'package:test_bench_example/generated/assets.dart';
import 'package:test_bench_example/rest_client.dart';
import 'package:test_bench_example/widgets/example_btn.dart';
...
Future<void> main() async {
  ...
  await TestBenchInitializer.instance.init(
    useDatabase: true,
  ...
  TestBenchInitializer.instance.onShareLogsFile = (String path) async {
...
class _MainPageState extends State<MainPage> {
  ...
  void initState() {
    ...
    TestBenchInitializer.instance.showDebugButton(
      context,
      left: 16,
    );
    ...
    TestBenchInitializer.instance.addValueNotifier(
      widget: intWidget,
    );
    ...
    /// Actions
    TestBenchInitializer.instance.addActionButton('Log Hi', () => log.i('Hi'));
    TestBenchInitializer.instance.addActionButton('Log By', () => log.i('By'));
  }
  ...
  void _toggleDebugButton(BuildContext context) {
    if (TestBenchInitializer.instance.isDebugButtonDisplayed) {
      TestBenchInitializer.instance.dismissDebugButton();
    } else {
      TestBenchInitializer.instance.showDebugButton(
        context,
        left: 16,
  ...
  Future<void> _makeRegularHttpRequest() async {
    ...
    try {
      ...
      TestBenchInitializer.instance.onHttpResponse(response, body);
  ...
  Future<void> _makeHttpClientRequest() async {
    ...
    try {
      ...
      TestBenchInitializer.instance.onHttpClientRequest(request, body);

      final response = await request.close();
      TestBenchInitializer.instance.onHttpClientResponse(
        response,
        request,
        body,
      );
  ...
  Future<void> _onDrop(dynamic value) async {
    ...
    try {
      ...
      await TestBenchInitializer.instance.createLogsFromJson(json);
