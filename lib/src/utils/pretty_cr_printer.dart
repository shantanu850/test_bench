...
import 'package:test_bench/src/log_message_wrapper.dart';
...
final class PrettyCRPrinter extends LogPrinter {
  ...
  List<String> log(LogEvent event) {
    ...
    return TestBenchHelper.instance.printLogs
        ? _formatAndPrint(
            event.level,
            messageStr,
            timeStr,
  ...
  String? _formatSTWeb(List<String> lines, int methodCount) {
    ...
    for (final line in lines) {
      if (line.contains(TestBenchHelper.instance.packageInfo.packageName)) {
        linesHasPackageName++;
