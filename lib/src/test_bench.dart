...
import 'package:test_bench/src/interceptor/cr_http_adapter.dart';
import 'package:test_bench/src/interceptor/cr_http_client_adapter.dart';
import 'package:test_bench/src/managers/log_manager.dart';
import 'package:test_bench/src/managers/transfer_manager.dart';
import 'package:test_bench/src/page/actions_and_values/actions_manager.dart';
import 'package:test_bench/src/page/actions_and_values/notifiers_manager.dart';
import 'package:test_bench/src/page/log_main/log_main.dart';
import 'package:test_bench/src/providers/sqflite_provider.dart';
import 'package:test_bench/src/res/theme.dart';
import 'package:test_bench/src/utils/console_log_output.dart';
import 'package:test_bench/src/utils/parsers/isolate_parser.dart';
import 'package:test_bench/src/utils/pretty_cr_printer.dart';
import 'package:test_bench/src/utils/show_log_snack_bar.dart';
...
final class TestBenchInitializer {
  TestBenchInitializer._();

  static const _channel = EventChannel(
    'com.erk.test_bench/logger',
  );

  static TestBenchInitializer instance = TestBenchInitializer._();
  ...
  bool _useTestBenchInReleaseBuild = false;
  ...
  bool get useTestBenchInReleaseBuild => _useTestBenchInReleaseBuild;
  ...
  /// [kReleaseMode] is true and the [useTestBenchInReleaseBuild] parameter is
  ...
  Future<void> init({
    bool printLogs = true,
    bool useTestBenchInReleaseBuild = false,
    ...
    _useTestBenchInReleaseBuild = useTestBenchInReleaseBuild;

    if (inited) {
      return;
    }

    await TestBenchHelper.instance.init();
    ...
    log.log = logger ??
        Logger(
          ...
          filter: useTestBenchInReleaseBuild
              ? ProductionFilter()
              : DevelopmentFilter(),
          level: Level.trace,
        );
    ...
    if (!kIsWeb && _useDB && useTestBenchInReleaseBuild) {
      await _initDB();
    }
    inited = true;
  }
  ...
  String? getProxySettings() =>
      TestBenchHelper.instance.getProxyFromSharedPref();
  ...
  void _showMenu(
    ...
    if (buttonEntry != null) {
      ...
      _onOpenLogger = () {
        ...
        TestBenchHelper.instance.showLogger();
      };
    }
  }
  ...
  void _onLoggerClose() {
    _loggerEntry?.remove();
    _loggerEntry = null;
    TestBenchHelper.instance.hideLogger();
  }
  ...
  Future<bool> _dispatchBackButton() async {
    if (TestBenchHelper.instance.isLoggerShowing) {
...
TestBenchWrapper log = TestBenchWrapper.instance;
