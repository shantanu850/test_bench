...
import 'package:test_bench/src/data/sqflite_db/converters/http_enitity_converter.dart';
import 'package:test_bench/src/data/sqflite_db/converters/log_entity_converters.dart';
import 'package:test_bench/src/data/sqflite_db/entities/http_entity.dart';
...
final class TransferManager {
  ...
  final _useDB = TestBenchHelper.instance.useDB;
  ...
  Future<void> createJsonFileAndShare() async {
    ...
    if (kIsWeb) {
      ...
      downloadLogsWeb('${TestBenchInitializer.instance.logFileName}.json', json);
      src.remove();
    } else {
      ...
      final path =
          '${tempDir.path}/${TestBenchInitializer.instance.logFileName}.json';
      final file = await File(path).create();
      await file.writeAsString(json);
      TestBenchInitializer.instance.onShareLogsFile?.call(path);
    }
  }
