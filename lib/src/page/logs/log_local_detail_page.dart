...
import 'package:test_bench/src/data/bean/log_bean.dart';
import 'package:test_bench/src/data/models/log_type.dart';
import 'package:test_bench/src/extensions/extensions.dart';
import 'package:test_bench/src/page/widgets/json_details_widget.dart';
import 'package:test_bench/src/res/colors.dart';
import 'package:test_bench/src/res/styles.dart';
import 'package:test_bench/src/utils/text_with_params_widget.dart';
                  ...
                  children: [
                    TextSpan(
                      ...
                      style: CRStyle.captionBlackRegular12
                          .copyWith(color: TestBenchColors.primaryColor),
                    ),
                    TextSpan(
                      text: stackTraceParts.last.split(')').first,
                      style: CRStyle.captionBlackSemiBold12
                          .copyWith(color: TestBenchColors.linkColor),
                    ),
                    TextSpan(
                      text: ')',
                      style: CRStyle.captionBlackRegular12
